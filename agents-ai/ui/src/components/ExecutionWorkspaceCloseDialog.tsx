...
import type { ExecutionWorkspace } from "@agentsai/shared";
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="break-words">
            ...
            artifacts. Agents keeps the workspace record and issue history, but removes it from active workspace views.
          </DialogDescription>
        </DialogHeader>
