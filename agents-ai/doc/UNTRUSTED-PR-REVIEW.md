...
This is intentionally separate from the normal AgentsAI dev image.
...
```sh
review-checkout-pr agentsai/agentsai 432
cd /work/checkouts/agentsai-agentsai/pr-432
```
...
## Preview the AgentsAI app from the PR
...
- AgentsAI's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.agentsai-review`.
