...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/agentsai-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - AgentsAI may create host-local worktrees, processes, and paths
- `cloud`
  - AgentsAI should assume no durable host-local execution workspace management
...
- `provider text not null`
  - `agentsai | github | vercel | s3 | custom`
