...
vi.mock("../hooks/useAgentsAIIssueRuntime", () => ({
...
describe("IssueChatThread", () => {
  ...
  it("shows unresolved blocker context above the composer", () => {
    ...
    expect(container.textContent).toContain(
      "Work on this issue is blocked by the linked issue",
    );
    expect(container.textContent).toContain(
      "Comments still wake the assignee for questions or triage",
    );
  ...
  it("renders the transcript directly from stable Agents messages", () => {
    const root = createRoot(container);
  ...
  it("shows full-composer drop instructions while dragging files over the issue composer", () => {
    ...
    expect(container.textContent).toContain(
      "Other files are added to this issue",
    );
