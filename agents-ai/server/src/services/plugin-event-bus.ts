/**
 * PluginEventBus — typed in-process event bus for the Agents plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@agentsai/shared";
import type { PluginEvent, EventFilter } from "@agentsai/plugin-sdk";
