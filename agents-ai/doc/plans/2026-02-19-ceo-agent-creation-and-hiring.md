...
- installed adapter list for this AgentsAI instance
...
## 8. New Skill: `agentsai-create-agent`

Create new skill directory:

- `skills/agentsai-create-agent/SKILL.md`
- `skills/agentsai-create-agent/references/api-reference.md`
...
Also update `skills/agentsai/SKILL.md` to reference this skill for hiring workflows.
...
- `agentsai-create-agent` skill + docs updates
