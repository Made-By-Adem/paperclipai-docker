...
AgentsAI exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-AgentsAI-Run-Id` header on all mutating requests during heartbeats
