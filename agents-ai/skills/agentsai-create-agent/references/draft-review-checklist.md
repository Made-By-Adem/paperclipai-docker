...
- [ ] The first paragraph points at the AgentsAI skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the AgentsAI execution contract verbatim:
...
- [ ] Adapter config matches this AgentsAI instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
