import type { PluginLauncherRegistration } from "@agentsai/plugin-sdk";

export const PLUGIN_ID = "Agents-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".Agents-kitchen-sink-demo.txt",
} as const;
