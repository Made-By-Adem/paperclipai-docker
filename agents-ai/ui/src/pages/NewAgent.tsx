...
import { AGENT_ROLES } from "@agentsai/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("Agentsai/Agents/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Agents runtime skills are added automatically.
              </p>
            </div>
