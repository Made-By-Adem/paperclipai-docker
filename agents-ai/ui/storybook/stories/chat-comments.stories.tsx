...
import type { Agent, FeedbackVote, IssueComment } from "@agentsai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/agentsaiData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Agents work: checkout, comments, linked runs, and review feedback.",
...
function ChatCommentsStories() {
  return (
    <div className="Agents-story">
      <main className="Agents-story__inner space-y-6">
        <section className="Agents-story__frame p-6">
          <div className="Agents-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Agents operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="Agents-story">
      <main className="Agents-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
