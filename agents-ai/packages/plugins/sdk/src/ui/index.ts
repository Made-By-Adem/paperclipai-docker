/**
 * `@agentsai/plugin-sdk/ui` — Agents plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@agentsai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@agentsai/plugin-sdk/ui";
 *
