...
Eval framework for testing AgentsAI agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the AgentsAI heartbeat skill:
