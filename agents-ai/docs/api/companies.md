...
Manage companies within your AgentsAI instance.
...
Company logo uploads use the normal AgentsAI attachment size limit.
...
| `logoUrl` | string | Optional AgentsAI asset content path for the stored logo image |
