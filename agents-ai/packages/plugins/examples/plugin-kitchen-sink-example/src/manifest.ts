...
const manifest: AgentsPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Agents plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Agents",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Agents domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
