...
Run this checklist on every heartbeat. This covers both your local planning/memory work and your organizational coordination via the AgentsAI skill.
...
- For scoped issue wakes, AgentsAI may already checkout the current issue in the harness before your run starts.
...
- Use `agentsai-create-agent` skill when hiring new agents.
...
- Always use the AgentsAI skill for coordination.
- Always include `X-AgentsAI-Run-Id` header on mutating API calls.
