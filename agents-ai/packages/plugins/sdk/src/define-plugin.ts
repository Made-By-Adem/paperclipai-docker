/**
 * `definePlugin` — the top-level helper for authoring a Agents plugin.
 *
...
// ---------------------------------------------------------------------------
// AgentsPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `AgentsPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@agentsai/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): AgentsPlugin {
