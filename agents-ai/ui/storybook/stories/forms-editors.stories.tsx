...
import { createIssue, storybookAgents } from "../fixtures/agentsaiData";
...
function Section({
  ...
  return (
    <section className="Agents-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="Agents-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="Agents-story">
      <main className="Agents-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/Agentsai/Agents).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Agents secret provider.",
    },
    concurrency: {
      type: "integer",
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Agents" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    defaultRef: "master",
    repoName: "Agents",
    localFolder: "/Users/dotta/Agents",
    managedFolder: "Agents",
    effectiveLocalFolder: "/Users/dotta/Agents",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="Agents-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="Agents-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Agents form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Agents form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
