...
async function getIssueWorkspaceRuntime(client: AgentsApiClient, issueId: string) {
...
export function createToolDefinitions(client: AgentsApiClient): ToolDefinition[] {
  return [
    makeTool(
      "AgentsMe",
      "Get the current authenticated Agents actor details",
      z.object({}),
    ...
    makeTool(
      "AgentsGetIssueWorkspaceRuntime",
    ...
    makeTool(
      "AgentsControlIssueWorkspaceServices",
    ...
    makeTool(
      "AgentsWaitForIssueWorkspaceService",
    ...
    makeTool(
      "AgentsRestoreIssueDocumentRevision",
    ...
    makeTool(
      "AgentsApiRequest",
      "Make a JSON request to an existing Agents /api endpoint for unsupported operations",
      apiRequestSchema,
