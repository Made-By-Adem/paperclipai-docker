...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@agentsai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Agents file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Agents storage.";
