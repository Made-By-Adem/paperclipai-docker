...
This document describes how `@agentsai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into AgentsAI logs/transcript parsing
