...
This document covers the GitHub and npm setup required for the current AgentsAI release model:
...
Do this for every public package that AgentsAI publishes.
...
3. add a trusted publisher for the GitHub repository `agentsai/agentsai`
...
2. revoke any personal automation token that used to publish AgentsAI
