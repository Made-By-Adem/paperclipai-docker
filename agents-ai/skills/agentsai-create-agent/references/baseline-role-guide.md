...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the AgentsAI heartbeat skill as the source of truth for the wake procedure.
...
When you wake up, follow the AgentsAI skill - it contains the full heartbeat procedure.
